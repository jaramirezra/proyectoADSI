...
$sql = "select * from jornadas where idjornadas='$zz'";
$query=$z->query($sql);
...
<form name="form1" method="post" action="2actualizar.php">
  ...
  <table width="200" border="1">
       <tr>
        ID
        <input type="text" name="idjornadas" nombre="idjornadas" required="" value="<?php echo $res['idjornadas'];?>">
    </tr>
      
    <tr>
        &nbsp;&nbsp;Sede:
        <input type="text" name="jornadas" id="jornadas" required="" value="<?php echo $res['jornadas']; } }?>">
    </tr>
