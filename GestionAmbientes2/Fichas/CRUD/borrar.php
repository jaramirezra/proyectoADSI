...
// Consulta en SQL
$query = "delete from fichas where idfichas='$a'";
$z->query($query);

?>
<br><br><p><a href="http://localhost:8080/ProyectoADSI/GestionAmbientes2/Fichas/fichas.php" id="volver">Volver menu principal</a></p>
  </div>
