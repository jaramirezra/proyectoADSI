...
$sql = "select * from fichas where idfichas='$zz'";
$query=$z->query($sql);
...
<form name="form1" method="post" action="2actualizar.php">
  ...
  <table width="200" border="1">
       <tr>
        ID
        <input type="text" name="idfichas" nombre="idfichas" required="" value="<?php echo $res['idfichas'];?>">
    </tr>
      
    <tr>
        &nbsp;&nbsp;Sede:
        <input type="text" name="fichasnom" id="fichasnom" required="" value="<?php echo $res['fichasNom']; } }?>">
    </tr>
...
<p><a href="http://localhost:8080/ProyectoADSI/GestionAmbientes2/Fichas/fichas.php" id="volver">Volver menu principal</a></p>
  </div>
