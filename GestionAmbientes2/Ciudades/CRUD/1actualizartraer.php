...
$sql = "select * from ciudades where idciudades='$zz'";
$query=$z->query($sql);
...
<form name="form1" method="post" action="2actualizar.php">
  ...
  <table width="200" border="1">
       <tr>
        ID
        <input type="text" name="idciudades" nombre="idciudades" required="" value="<?php echo $res['idciudades'];?>">
    </tr>
      
    <tr>
        &nbsp;&nbsp;Municipio:
        <input type="text" name="ciudades" id="ciudades" required="" value="<?php echo $res['ciudades']; } }?>">
    </tr>
    <tr>
