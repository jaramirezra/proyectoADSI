...
echo "<p>Ciudades actualizadas</p><br><br>";
$b=$_POST["idciudades"];
$a=$_POST["ciudades"];
...
// Consulta en SQL
$query =  "UPDATE `ciudades` set `ciudades`='$a' where idciudades='$b'";
$z->query($query);
//echo $z;
?>
<p><a href="http://localhost:8080/ProyectoADSI/GestionAmbientes2/Ciudades/ciudades.php" id="volver"><br>Volver menu principal</a></p>
  </div>
