...
$sql = "select * from departamentos where iddepartamentos='$zz'";
$query=$z->query($sql);
...
<form name="form1" method="post" action="2actualizar.php">
  ...
  <table width="200" border="1">
    <tr>
        ID
        <input type="text" name="iddepartamentos" nombre="iddepartamentos" required="" value="<?php echo $res['iddepartamentos'];?>">
    </tr>
      
    <tr>
        &nbsp;&nbsp;Departamentos:
        <input type="text" name="departamentos" id="departamentos" required="" value="<?php echo $res['departamentos']; } }?>">
    </tr>
    <tr>
