...
if(isset($_POST['btn-signup']))
{
  ...
  else
  {
    if($reg_user->register($uname,$email,$upass,$code))
    {
      ...
      $id = $key;
      $message = "Hello $uname,<br/><br/>Welcome <br/>Para completar su registro, haga clic en el enlace siguiente<br/>
      <br/><br/><a href='http://localhost:8080/ProyectoADSI/login/verify2.php?id=$id&code=$code'>Haga clic AQUÍ para activar:)
      </a><br/><br/>Thanks,";
...
<body id="login">
  <div class="container" id="container">
    ...
    <form class="form-signin" method="post">
      ...
      <br><p>Contraseña</p>
      <input type="password" class="input-block-level" id="padding" placeholder="&#128272;Contraseña" name="txtpass" required />
      <hr/>
      <button class="btn btn-large btn-primary" type="submit" name="btn-signup">Registrate</button><br><br>  
      <a href="index2.php" class="btn-btn-large"><p>Atras</p></a>
      </form>
    </div>
